        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8 lg:py-32">
          ...
          >
            ...
            <form
              ...
              className="mt-8 flex max-w-lg gap-2 rounded-full border border-border bg-card p-1.5 shadow-md"
            >
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
          {(reviews.data && reviews.data.length >= 4
            ...
            : [1, 2, 3, 4].map((n) => ({
                ...
                user: {
                  _id: `u${n}`,
                  name: ["Anika J.", "Marcus O.", "Priya S.", "Elena V."][
                    n - 1
                  ],
                },
      ...
      <section className="mx-auto max-w-4xl px-4 pb-20 sm:px-6 lg:px-8">
        <div className="rounded-3xl bg-gradient-cream p-10 text-center shadow-md">
          ...
          >
            ...
            />
            <Button className="h-11 rounded-full bg-gradient-hero px-6 text-primary-foreground hover:opacity-90">
              Subscribe
            </Button>
          </form>
        </div>

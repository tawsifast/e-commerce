    ...
    <div className="bg-background">
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroImage.src} alt="" className="h-full w-full object-cover" />
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8 lg:py-32">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="flex flex-col justify-center">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/products"><Button variant="outline" className="rounded-full">Shop all products <ArrowRight className="ml-1 h-4 w-4" /></Button></Link>
              <Link href="/register"><Button variant="ghost" className="rounded-full">Sell on Marketa</Button></Link>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="bg-surface">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between">
            ...
            <Link href="/products" className="hidden text-sm font-medium underline-offset-4 hover:underline sm:inline">View all →</Link>
          </div>

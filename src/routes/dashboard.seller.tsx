...
export const Route = createFileRoute("/dashboard/seller")({
  head: () => ({
    meta: [
      { title: "Seller Dashboard — Marketa" },
      { name: "description", content: "Manage your products, orders and analytics." },
                ...
                <tr key={p._id} className="border-t border-border">
                  <td className="px-6 py-3">
                    <div className="flex items-center gap-3">
                      ...
                      <Link to="/products/$id" params={{ id: p._id }} className="line-clamp-1 font-medium hover:underline">
                        {p.title}
                      </Link>
                    </div>
                  </td>

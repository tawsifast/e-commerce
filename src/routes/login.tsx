...
export const Route = createFileRoute("/login")({
  head: () => ({
    meta: [
      { title: "Sign in — Marketa" },
      { name: "description", content: "Sign in to your Marketa account." },
    ...
    <div className="mx-auto grid min-h-[calc(100vh-4rem)] max-w-6xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:px-8">
      ...
      <div className="flex items-center justify-center">
        <div className="w-full max-w-md">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Don't have an account? <Link to="/register" className="font-medium text-primary underline-offset-4 hover:underline">Create one</Link></p>
